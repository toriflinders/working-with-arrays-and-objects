...
// .filter(monstersInYourPocket => monstersInYourPocket.monster)
// .map(monstersInYourPocket => monstersInYourPocket.CP < 200)
// .reduce((sum, monstersInYourPocket) => sum => monstersInYourPocket);
...
// .filter(pur => pur.owner === "Bob")
// .map(pur => pur.price)
// .reduce((sum, pur) => sum = pur);
